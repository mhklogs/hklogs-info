...
export const staticProjects: LocalProject[] = [
  {
    ...
    vercelUrl: "https://haze-agent-suite-7rirzeff2-hasaanzia02-8696s-projects.vercel.app",
  ...
  {
    name: "FixIt — Home Services OS",
    desc: "Vertical home-services operating system and marketplace (FixIt) unifying customer jobs, contractor onboarding, and admin dispatch under one brand.",
    ...
    usecase: "Powers end-to-end home-service flows: homeowners post jobs, verified contractors quote, and admins dispatch plus audit payouts.",
    working: "Shares a package workspace across marketplace, admin, and customer apps; syncs verified review widgets and the instant-quote engine across the FixIt suite."
  },
  {
...
name: "ai-recruitment-auditor",
    ...
    vercelUrl: "https://ai-recruitment-auditor-egx5fv2cx-hasaanzia02-8696s-projects.vercel.app",
...
name: "sentient-ai-multimodal-hub",
    ...
    vercelUrl: "https://sentient-ai-multimodal-lmxye79gk-hasaanzia02-8696s-projects.vercel.app",
...
name: "Bridgebot Code Migrator",
    ...
    vercelUrl: "https://code-migration-agent-2bbgr640h-hasaanzia02-8696s-projects.vercel.app",
...
name: "Nexus-fx",
    ...
    vercelUrl: "https://nexus-9w3787l6m-hasaanzia02-8696s-projects.vercel.app",
...
name: "Relevnt",
    ...
    vercelUrl: "https://relevnt-5gnwjm3g8-hasaanzia02-8696s-projects.vercel.app",
...
name: "support-escalation-hub",
    ...
    vercelUrl: "https://support-escalation-9dsbcy6bz-hasaanzia02-8696s-projects.vercel.app",
...
name: "Crazy Leads (NexLeed CRM / MarketForge)",
    ...
    vercelUrl: "https://marketforge-3l8zzgbmc-hasaanzia02-8696s-projects.vercel.app",
  ...
  },
  {
    ...
    vercelUrl: "https://prioriti-3xghpjyz7-hasaanzia02-8696s-projects.vercel.app",
...
name: "geoengineai",
    ...
    vercelUrl: "https://geoengineai-gxo0678hj-hasaanzia02-8696s-projects.vercel.app",
...
name: "optimared-ai-pricing-agent",
    ...
    vercelUrl: "https://optimared-ai-pricing-agent-9siewet3h-hasaanzia02-8696s-projects.vercel.app",
...
name: "AI-powered-Podcast-Agent",
    ...
    vercelUrl: "https://ai-powered-podcast-agent-r4np9h38s-hasaanzia02-8696s-projects.vercel.app",
...
- Key projects: Revenue Orbit Marketing (revenueorbitmarketing.com), Accident Care Helpline (accidentcarehelpline.com — personal-injury lead gen with TrustedForm), ISHAARA (bi-directional sign language translator), CBO-RuralWSD (offline-first PWA for rural water billing), ReferralClose LLC & home.referralclose, Primus Leads, ai-recruitment-auditor (Gemini resume screening), sentient-ai-multimodal-hub, Bridgebot code migrator, Relevnt (legal compliance search), PocketMint, Prioriti, geoengineai, AI Podcast Agent (LangGraph), optimared pricing agent, Haze Agent Suite (agentic AI control room), FixIt home-services OS, AppointmentBookingApp, GetAuto, and more.
