...
export const personalInfo = {
  ...
  github: "https://github.com/mhklogs",
...
export const staticProjects: LocalProject[] = [
  {
    name: "Haze Agent Suite",
    desc: "A unified agentic AI platform bundling Gemini-driven sub-agents for deep research, code analysis, automation, and multimodal content workflows inside one dashboard.",
  ...
  {
    name: "HomeFix OS",
    desc: "The managed HomeFix OS network — a call center + pay-per-call lead system with RTP (real-time phone) lines, live agent intake, fixed quotes, escrow deposits, and a vetted contractor pool. Runs the way Yango runs its fleets: assigned and accountable.",
...
name: "ReferralClose LLC",
    ...
    url: "https://github.com/mhklogs/referral-close-llc",
...
name: "home.referralclose",
    ...
    url: "https://github.com/mhklogs/new.home.referralclose",
...
name: "Accident Care Helpline (Accident Case Win)",
    ...
    url: "https://github.com/mhklogs/Accidental-Case-Win-Project",
  ...
  },
{
 name: "ultd-realestate",
    ...
    url: "https://github.com/mhklogs/ultd-realestate",
...
name: "CBO-RuralWSD (cboruralwater)",
    ...
    url: "https://github.com/mhklogs/cboruralwater",
...
name: "ai-recruitment-auditor",
    ...
    url: "https://github.com/mhklogs/ai-recruitment-auditor",
...
name: "PDS Website",
    ...
    url: "https://github.com/mhklogs/pakistan-debating-society",
...
name: "sentient-ai-multimodal-hub",
    ...
    url: "https://github.com/mhklogs/sentient-ai-multimodal-hub",
...
name: "ISHAARA — Bi-Directional Sign Language Translator",
    ...
    url: "https://github.com/mhklogs/ishaara-sign-language-translator",
...
name: "Relevnt",
    ...
    url: "https://github.com/mhklogs/Relevnt",
...
name: "Crazy Leads (NexLeed CRM / MarketForge)",
    desc: "An advanced lead scraping dashboard built for sales outreach managers and CRM administrators. It aggregates B2B client emails, structures marketing campaign pipelines, and provides campaign conversion graphs. It handles data cleaning scripts to remove corrupt records from campaign pools.",
    url: "https://github.com/mhklogs/MarketForge",
    vercelUrl: "https://marketforge-kappa.vercel.app",
  ...
  },
  {
    ...
    url: "https://github.com/mhklogs/Prioriti",
  ...
  },
  {
    ...
    url: "https://github.com/mhklogs/PocketMint",
...
name: "geoengineai",
    ...
    url: "https://github.com/mhklogs/geoengineai",
...
name: "optimared-ai-pricing-agent",
    ...
    url: "https://github.com/mhklogs/optimared-ai-pricing-agent",
    vercelUrl: "https://optimared-ai-pricing-agent.vercel.app",
...
name: "AI-powered-Podcast-Agent",
    ...
    url: "https://github.com/mhklogs/AI-powered-Podcast-Agent",
...
name: "Kareemiya Site",
    ...
    url: "https://github.com/mhklogs/kareemiya-site",
...
name: "AutonAI",
    ...
    url: "https://github.com/mhklogs/AutonAI",
...
name: "Agentic-Legal-Assistant",
    ...
    url: "https://github.com/mhklogs/Agentic-Legal-Assistant-Multi-Tool-AI-Agent-with-Gemini-2.5-Flash",
...
name: "AppointmentBookingApp",
    ...
    url: "https://github.com/mhklogs/AppointmentBookingApp",
...
name: "AatendenceAPP",
    ...
    url: "https://github.com/mhklogs/AatendenceAPP",
...
name: "GetAuto Car Rental",
    ...
    url: "https://github.com/mhklogs/GetAuto",
...
name: "Legal-AI-Assistant",
    ...
    url: "https://github.com/mhklogs/Legal-AI-Assistant",
...
name: "liberty-assist",
    ...
    url: "https://github.com/mhklogs/liberty-assist",
...
name: "scientific-research-synthesis-agent",
    ...
    url: "https://github.com/mhklogs/scientific-research-synthesis-agent",
...
name: "YoungDev-Intern-C--Tasks",
    ...
    url: "https://github.com/mhklogs/YoungDev-Intern-C--Tasks",
...
name: "UiSpecificationEngine (C-Style to React Transpiler)",
    ...
    url: "https://github.com/mhklogs/UiSpecificationEngine",
  ...
  {
    name: "Crazy Closers",
    desc: "A B2B sales-intelligence and call-management platform feeding qualified leads and live call flows to closing teams, with pipeline scoring and outcome analytics.",
  ...
  {
    name: "HomeFix CRM Hub",
    desc: "Call-center and pay-per-call infrastructure for home-services lead routing — RTP lines, live agent intake, and contractor dispatch records in one operations hub.",
    url: "https://github.com/mhklogs/crm-hub",
    tech: ["React", "Express", "SQLite", "Tailwind CSS"],
    thumbnail: "/recruiter_ai_thumb.png",
    usecase: "Runs the managed-side operations for the HomeFix OS network: screens inbound calls, quotes, and dispatches verified contractors.",
    working: "Presents a live telephony panel and dispatch ledger, persisting each call-to-paid-job record and payout in SQLite."
  },
  {
    name: "Open-SEO",
    desc: "An AI-powered SEO content creation and optimization engine — keyword research, topically-aware briefs, and page-level SEO scoring for content teams.",
  ...
  {
    name: "ReferralClose — New Portal",
    desc: "Next iteration of the ReferralClose contractor-network portal, modernized for lead routing and payout ledger management.",
    url: "https://github.com/mhklogs/referralclose-llc-new",
    tech: ["TypeScript", "Next.js", "Supabase", "Tailwind CSS"],
    thumbnail: "/referralclose_llc_new_thumb.png",
    usecase: "Administers B2B contractor networks and lead distribution in the newer ReferralClose stack.",
    working: "Routes location/trade-matched leads and audits payout ledgers through Supabase-connected services."
  },
  {
    name: "ReferralClose — Marketplace",
    desc: "Marketplace-track build of the ReferralClose home-service network for homeowners and contractors.",
    url: "https://github.com/mhklogs/referralclose-llc-marketplace",
    tech: ["TypeScript", "Next.js", "Supabase", "Tailwind CSS"],
    thumbnail: "/home_referralclose_new_thumb.png",
    usecase: "Powers homeowner job posting, contractor quoting, and admin dispatch in the marketplace variant.",
    working: "Maintains shared marketplace schemas for jobs, quotes, and payout tracking."
  },
  {
    name: "ReferralClose — Home Service Marketplace",
    desc: "Home-service marketplace build powering customer job requests and verified contractor matching.",
    url: "https://github.com/mhklogs/referralclose-home-service-marketplace",
    tech: ["TypeScript", "Next.js", "Supabase", "Tailwind CSS"],
    thumbnail: "/home_referralclose_new_thumb.png",
    usecase: "Connects homeowners with verified pros for home improvement projects.",
    working: "Serves the job-to-quote-to-schedule flow backed by Supabase database clusters."
  },
  {
    name: "CBO Rural Water — Saman",
    desc: "Additional deployment of the rural water scheme management PWA tailored for the Saman water committee operating area.",
    url: "https://github.com/mhklogs/cboruralwatersaman",
    tech: ["React", "Express", "Firebase", "PostgreSQL", "PWA"],
    thumbnail: "/cborural_new_thumb.png",
